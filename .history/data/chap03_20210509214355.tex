...
\begin{table}[]
    ...
    \begin{tabular}{@{}clccc@{}}
        \toprule
        序列类别                               & \multicolumn{1}{c}{序列}     & \multicolumn{1}{l}{分辨率} & 码率     & 编码时间 \\ \midrule
        \multirow{2}{*}{ClassA}                & PeopleOnStreet               & 2560×1600                  & -11.29\% & 125.98\% \\
                                               & Traffic                      & 2560×1600                  & -11.46\% & 124.76\% \\
        \multirow{5}{*}{ClassB}                & BasketballDrive              & 1920×1080                  & -4.20\%  & 126.57\% \\
                                               & BQTerrace                    & 1920×1080                  & -8.57\%  & 125.85\% \\
                                               & Cactus                       & 1920×1080                  & -3.74\%  & 126.96\% \\
                                               & Kimono                       & 1920×1080                  & -7.71\%  & 127.41\% \\
                                               & ParkScene                    & 832×480                    & -6.58\%  & 127.37\% \\
        \multirow{4}{*}{ClassC}                & BasketballDrill              & 832×480                    & -5.51\%  & 126.32\% \\
                                               & BQMall                       & 832×480                    & -6.17\%  & 126.48\% \\
                                               & PartyScene                   & 832×480                    & -5.58\%  & 125.11\% \\
                                               & RaceHorsesC                  & 832×480                    & -8.10\%  & 124.38\% \\
        \multirow{4}{*}{ClassD}                & BasketballPass               & 416×240                    & -12.36\% & 124.54\% \\
                                               & BlowingBubbles               & 416×240                    & -5.47\%  & 125.01\% \\
                                               & BQSquare                     & 416×240                    & -5.27\%  & 124.80\% \\
                                               & RaceHorses                   & 416×240                    & -8.51\%  & 125.34\% \\
        \multirow{3}{*}{ClassE}                & FourPeople                   & 1280×720                   & -12.51\% & 124.64\% \\
                                               & Johnny                       & 1280×720                   & -10.97\% & 124.51\% \\
                                               & KristenAndSara               & 1280×720                   & -11.86\% & 123.96\% \\
        \multirow{4}{*}{ClassF}                & BasketballDrillText          & 832×480                    & -6.07\%  & 124.67\% \\
                                               & ChinaSpeed                   & 1024×768                   & -17.15\% & 121.53\% \\
                                               & SlideEditing                 & 1280×720                   & -13.57\% & 123.07\% \\
                                               & SlideShow                    & 1280×720                   & -22.26\% & 126.19\% \\ \midrule
        \multicolumn{2}{c}{ClassA$\sim$E 均值} & -                            & -8.10\%                    & 125.56\%            \\ \midrule
        \multicolumn{2}{c}{ClassF 均值}        & -                            & -14.76\%                   & 123.87\%            \\ \midrule
        \multicolumn{2}{c}{ClassA$\sim$F 均值} & -                            & -9.31\%                    & 125.25\%            \\ \midrule
        \multicolumn{2}{c}{解码时间}           & \multicolumn{3}{c}{103.21\%}                                                    \\ \bottomrule
    \end{tabular}
\end{table}

使用码率降低的百分比来衡量算法性能，表中负值表示使用 L-IP 算法编码得到的结果码率降低了。
