...
\section{国内外研究现状}
H.26X 系列编码标准可以通过简单地跳过变换、量化、去块滤波、自适应样点补偿等可能引入失真的步骤，实现无损帧内压缩\upcite{BypassImprovingSCC}。但也因此使得待编码系数具有较高的能量，为后续的熵编码带来极大的压力。为优化H.26X系列标准无损帧内编码的性能，国内外学者进行了大量的研究。
