...
值得一提的是，本课题还尝试将 R-MED 算法应用在有损压缩上，测试结果显示其在编码高分辨率图像和屏幕图像的结果中得到了 2\%\textasciitilde 3\% 的码率优化，尽管有损编码时的待编码系数不再具有空间相关性，但 R-MED 仍有一定的降低数据能量的作用，这涉及到将来课题的研究能容，在此不再具体展开。
