...
\begin{table}[hbt]
    ...
    \begin{tabular}{@{}clccc@{}}
        ...
        \multirow{4}{*}{ClassF}                & BasketballDrillText          & 832$\times$480   & -6.07\%  & 124.67\% \\
                                               ...
                                               & SlideShow                    & 1280$\times$720  & -22.26\% & 126.19\% \\ \hline
        \multicolumn{2}{l}{ClassA$\sim$E 均值} & -                            & -8.10\%          & 125.56\%            \\ \hline
        \multicolumn{2}{l}{ClassF 均值}        & -                            & -14.76\%         & 123.87\%            \\ \hline
        \multicolumn{2}{l}{ClassA$\sim$F 均值} & -                            & -9.31\%          & 125.25\%            \\ \hline
        \multicolumn{2}{l}{解码时间}           & \multicolumn{3}{c}{103.21\%}                                          \\ \hline
    \end{tabular}
\end{table}
...
\begin{table}[hbt]
    ...
    \begin{tabular}{clccc}
        ...
        \multirow{4}{*}{ClassF}                & BasketballDrillText          & 832$\times$480   & -1.96\%  & 101.00\% \\
                                               ...
                                               & SlideShow                    & 1280$\times$720  & -5.43\%  & 102.68\% \\ \hline
