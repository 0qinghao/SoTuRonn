...
\begin{tabular}{@{}llll@{}}
\toprule
\multicolumn{1}{c}{\multirow{2}{*}{序列类别}} & \multicolumn{1}{c}{\multirow{2}{*}{序列}} & \multicolumn{2}{c}{H.265+R-MED vs}                                        \\ \cmidrule(l){3-4} 
\multicolumn{1}{c}{}                      & \multicolumn{1}{c}{}                    & \multicolumn{1}{c}{Bypass TransQuant} & \multicolumn{1}{c}{RDPCM {[}5{]}} \\ \midrule
\multirow{2}{*}{A} & PeopleOnStreet  & -11.10\% & -5.99\% \\
                   & Traffic         & -10.10\% & -3.54\% \\
\multirow{4}{*}{B} & BasketballDrive & -2.19\%  & -0.49\% \\
                   & BQTerrace       & -5.43\%  & -0.96\% \\
                   & Cactus          & -2.92\%  & -0.99\% \\
                   & Kimono          & -6.82\%  & -2.63\% \\
\multirow{5}{*}{C} & ParkScene       & -5.85\%  & -2.26\% \\
                   & BasketballDrill & -2.61\%  & -1.14\% \\
                   & BQMall          & -4.16\%  & -0.66\% \\
                   & PartyScene      & -3.80\%  & -0.51\% \\
                   & RaceHorsesC     & -7.03\%  & -2.64\% \\
\multirow{4}{*}{D} & BasketballPass  & -9.10\%  & -1.92\% \\
                   & BlowingBubbles  & -4.11\%  & -1.93\% \\
                   & BQSquare        & -3.10\%  & -0.48\% \\
                   & RaceHorses      & -8.29\%  & -3.53\% \\
\multirow{6}{*}{E} & FourPeople      & -9.23\%  & -3.83\% \\
                   & Johnny          & -6.99\%  & -2.58\% \\
                   & KristenAndSara  & -7.35\%  & -2.60\% \\
                   & Vidyo1          & -9.93\%  & -3.30\% \\
                   & Vidyo3          & -9.10\%  & -3.60\% \\
                   & Vidyo4          & -8.92\%  & -2.65\% \\
\multirow{4}{*}{F}                        & BasketballDrillText                     & -3.01\%                               & -1.19\%                           \\
                   & ChinaSpeed      & -9.13\%  & -1.35\% \\
                   & SlideEditing    & -7.33\%  & -0.51\% \\
                   & SlideShow       & -18.45\% & -5.16\% \\ \midrule
