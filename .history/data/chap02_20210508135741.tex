...
同时，为了适应不同的场景需求，视频编码标准中存在大量可配置参数用于调控编码效率、失真度和编码复杂度，因此，如何在标准的编码框架下得到不同场景下最优的编码效率与失真度的平衡，是编码标准中未规定的算法研究的核心内容，寻找折衷点的过程被称为率-失真优化\upcite{VVCCompressRatio40PercentTime15xRDORef}。
