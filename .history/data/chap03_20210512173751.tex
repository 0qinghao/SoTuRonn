...
\begin{tabular}{@{}clccc@{}}
\multirow{2}{*}{序列类别} & \multicolumn{1}{c}{\multirow{2}{*}{序列}} & \multirow{2}{*}{分辨率} & \multicolumn{2}{c}{H.265+R-MED vs} \\
                   & \multicolumn{1}{c}{} &           & Bypass TransQuant & RDPCM {[}5{]} \\
...
\multirow{4}{*}{F} & BasketballDrillText  & 832x480   & -3.01\%           & -1.19\%       \\
                   ...
                   & SlideShow            & 1280x720  & -18.45\%          & -5.16\%       \\
\multicolumn{2}{l}{平均码率优化}                &           & -7.04\%           & -2.26\%       \\
\multicolumn{2}{l}{编码时间}                  &           & 104\%             & 107\%         \\
\multicolumn{2}{l}{解码时间}                  &           & 95\%              & 98\%         
\end{tabular}
\end{table}
