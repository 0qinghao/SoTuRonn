...
由于 H.26X 标准中未规定率-失真优化的具体技术细节，因此编码器可自定义、优化参数选择的过程，本课题是基于 HM 开展的，因此本节简单介绍 HM 的率失真优化方法。率-失真优化方法可在图像组 (Group of Pictures, GOP) 层、片 (Slice) 层、编码树单元 (Coding Tree Unit, CTU) 层、CU 层和 PU 层应用。
