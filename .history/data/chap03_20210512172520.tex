...
最后，应用 R-MED 算法进行实际编码测试。与 \ref{cha:L-IPTest} 节、\ref{cha:L-BPTest} 节的测试不同，由于 R-MED 算法通用性极强，可在 H.26X 系列编码标准中通用，因此 R-MED 分别在 H.265 标准参考软件 HM-16.21\upcite{HEVCsoftwareHM16} 和 H.266 标准参考软件 VTM-12.3\upcite{VVCsoftwareVTM} 中实现，并使用 JCT-VC 推荐的标准测试序列进行测试。结果统计如表 \ref{tab:R-MEDsummary} 所示。
\begin{table}[]
\centering
\caption{R-MED 算法应用在 H.265 及 H.266 的性能测试}
\label{tab:R-MEDsummary}
\begin{tabular}{@{}llllllll@{}}
\toprule
\multicolumn{1}{c}{\multirow{2}{*}{序列类别}} &
  \multicolumn{1}{c}{\multirow{2}{*}{序列}} &
  \multicolumn{1}{c}{\multirow{2}{*}{分辨率}} &
  \multicolumn{1}{c}{\multirow{2}{*}{帧数}} &
  \multicolumn{2}{c}{H.265 + R-MED vs} &
  \multicolumn{2}{c}{H.266 + R-MED vs} \\ \cmidrule(l){5-8} 
\multicolumn{1}{c}{} &
  \multicolumn{1}{c}{} &
  \multicolumn{1}{c}{} &
  \multicolumn{1}{c}{} &
  \multicolumn{1}{c}{H.265 bypass TransQuant} &
  \multicolumn{1}{c}{H.265 RDPCM {[}5{]}} &
  \multicolumn{1}{c}{H.266 bypass TransQuant} &
  \multicolumn{1}{c}{H.266 BDPCM {[}1{]}} \\ \midrule
A   & PeopleOnStreet       & 2560×1600 & 150 & -11.10\% & -5.99\% & -9.67\%  & -5.99\% \\
A   & Traffic              & 2560×1600 & 150 & -10.10\% & -3.54\% & -8.60\%  & -3.77\% \\
B   & BasketballDrive      & 1920×1080 & 500 & -2.19\%  & -0.49\% & -1.42\%  & -0.52\% \\
B   & BQTerrace            & 1920×1080 & 600 & -5.43\%  & -0.96\% & -4.16\%  & -1.15\% \\
B   & Cactus               & 1920×1080 & 500 & -2.92\%  & -0.99\% & -2.14\%  & -1.05\% \\
B   & Kimono               & 1920×1080 & 240 & -6.82\%  & -2.63\% & -5.96\%  & -3.35\% \\
C   & ParkScene            & 832×480   & 240 & -5.85\%  & -2.26\% & -4.87\%  & -2.58\% \\
C   & BasketballDrill      & 832×480   & 500 & -2.61\%  & -1.14\% & -1.92\%  & -1.22\% \\
C   & BQMall               & 832×480   & 600 & -4.16\%  & -0.66\% & -3.10\%  & -0.86\% \\
C   & PartyScene           & 832×480   & 500 & -3.80\%  & -0.51\% & -2.65\%  & -0.69\% \\
D   & RaceHorsesC          & 416×240   & 300 & -7.03\%  & -2.64\% & -6.13\%  & -3.25\% \\
D   & BasketballPass       & 416×240   & 500 & -9.10\%  & -1.92\% & -7.71\%  & -2.69\% \\
D   & BlowingBubbles       & 416×240   & 500 & -4.11\%  & -1.93\% & -3.15\%  & -0.75\% \\
D   & BQSquare             & 416×240   & 600 & -3.10\%  & -0.48\% & -2.24\%  & -0.56\% \\
D   & RaceHorses           & 416×240   & 300 & -8.29\%  & -3.53\% & -7.23\%  & -3.58\% \\
E   & FourPeople           & 1280×720  & 600 & -9.23\%  & -3.83\% & -7.92\%  & -3.97\% \\
E   & Johnny               & 1280×720  & 600 & -6.99\%  & -2.58\% & -6.13\%  & -3.04\% \\
E   & KristenAndSara       & 1280×720  & 600 & -7.35\%  & -2.60\% & -6.40\%  & -2.82\% \\
E   & Vidyo1               & 1280×720  & 600 & -9.93\%  & -3.30\% & -8.56\%  & -3.65\% \\
E   & Vidyo3               & 1280×720  & 600 & -9.10\%  & -3.60\% & -7.64\%  & -3.80\% \\
E   & Vidyo4               & 1280×720  & 600 & -8.92\%  & -2.65\% & -7.36\%  & -3.04\% \\
F   & BasketballDrillText  & 832×480   & 500 & -3.01\%  & -1.19\% & -2.21\%  & -1.17\% \\
F   & ChinaSpeed           & 1024×768  & 500 & -9.13\%  & -1.35\% & -7.86\%  & -1.47\% \\
F   & SlideEditing         & 1280×720  & 300 & -7.33\%  & -0.51\% & -7.20\%  & -0.80\% \\
F   & SlideShow            & 1280×720  & 500 & -18.45\% & -5.16\% & -17.36\% & -6.73\% \\
\multicolumn{2}{l}{平均码率优化} &           &     & -7.04\%  & -2.26\% & -5.98\%  & -2.50\% \\
\multicolumn{2}{l}{编码时间}   &           &     & 104\%    & 107\%   & 117\%    & 111\%   \\
\multicolumn{2}{l}{解码时间}   &           &     & 95\%     & 98\%    & 83\%     & 93\%    \\ \bottomrule
\end{tabular}
\end{table}
