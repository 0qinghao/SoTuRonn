...
\end{figure}
从图中可观察到在基于四叉树结构的分块算法下，由于右下角区域存在极小部分纹理丰富的区域，CTU 经过 RDO 被切分为 19 个独立进行预测的小块，因此编码该 CTU 需要处理的数据有：64$\times$2 个预测残差；19 个预测模式信息；13 个分块标志。尽管左、上侧 3 个较大块可能使用的是相同的预测模式，也必须编码 3 次预测模式信息，一定程度上降低了编码效率。在充分理解 H.26X 帧内分块过程存在的缺陷后，下一节将提出本课题的改进算法。
...
\begin{table}[!p]
    ...
    \begin{tabular}{@{}clccc@{}}
        ...
        \multirow{2}{*}{A}               & PeopleOnStreet                            & 2560$\times$2               & -11.10\%                           & -5.99\%                       \\
                                         & Traffic                                   & 2560$\times$2               & -10.10\%                           & -3.54\%                       \\
        \multirow{4}{*}{B}               & BasketballDrive                           & 1920$\times$2               & -2.19\%                            & -0.49\%                       \\
                                         & BQTerrace                                 & 1920$\times$2               & -5.43\%                            & -0.96\%                       \\
                                         & Cactus                                    & 1920$\times$2               & -2.92\%                            & -0.99\%                       \\
                                         & Kimono                                    & 1920$\times$2               & -6.82\%                            & -2.63\%                       \\
        \multirow{5}{*}{C}               & ParkScene                                 & 832$\times$2                 & -5.85\%                            & -2.26\%                       \\
                                         & BasketballDrill                           & 832$\times$2                 & -2.61\%                            & -1.14\%                       \\
                                         & BQMall                                    & 832$\times$2                 & -4.16\%                            & -0.66\%                       \\
                                         & PartyScene                                & 832$\times$2                 & -3.80\%                            & -0.51\%                       \\
                                         & RaceHorsesC                               & 832$\times$2                 & -7.03\%                            & -2.64\%                       \\
        \multirow{4}{*}{D}               & BasketballPass                            & 416$\times$2                 & -9.10\%                            & -1.92\%                       \\
                                         & BlowingBubbles                            & 416$\times$2                 & -4.11\%                            & -1.93\%                       \\
                                         & BQSquare                                  & 416$\times$2                 & -3.10\%                            & -0.48\%                       \\
                                         & RaceHorses                                & 416$\times$2                 & -8.29\%                            & -3.53\%                       \\
        \multirow{6}{*}{E}               & FourPeople                                & 1280$\times$2                & -9.23\%                            & -3.83\%                       \\
                                         & Johnny                                    & 1280$\times$2                & -6.99\%                            & -2.58\%                       \\
                                         & KristenAndSara                            & 1280$\times$2                & -7.35\%                            & -2.60\%                       \\
                                         & Vidyo1                                    & 1280$\times$2                & -9.93\%                            & -3.30\%                       \\
                                         & Vidyo3                                    & 1280$\times$2                & -9.10\%                            & -3.60\%                       \\
                                         & Vidyo4                                    & 1280$\times$2                & -8.92\%                            & -2.65\%                       \\
        \multirow{4}{*}{F}               & BasketballDrillText                       & 832$\times$2                 & -3.01\%                            & -1.19\%                       \\
                                         & ChinaSpeed                                & 1024$\times$2                & -9.13\%                            & -1.35\%                       \\
                                         & SlideEditing                              & 1280$\times$2                & -7.33\%                            & -0.51\%                       \\
                                         & SlideShow                                 & 1280$\times$2                & -18.45\%                           & -5.16\%                       \\ \midrule
...
\begin{table}[!p]
    ...
    \begin{tabular}{@{}clccc@{}}
        ...
        \multirow{2}{*}{A}               & PeopleOnStreet                            & 2560$\times$2               & -9.67\%                            & -5.99\%                    \\
                                         & Traffic                                   & 2560$\times$2               & -8.60\%                            & -3.77\%                    \\
        \multirow{4}{*}{B}               & BasketballDrive                           & 1920$\times$2               & -1.42\%                            & -0.52\%                    \\
                                         & BQTerrace                                 & 1920$\times$2               & -4.16\%                            & -1.15\%                    \\
                                         & Cactus                                    & 1920$\times$2               & -2.14\%                            & -1.05\%                    \\
                                         & Kimono                                    & 1920$\times$2               & -5.96\%                            & -3.35\%                    \\
        \multirow{5}{*}{C}               & ParkScene                                 & 832$\times$2                 & -4.87\%                            & -2.58\%                    \\
                                         & BasketballDrill                           & 832$\times$2                 & -1.92\%                            & -1.22\%                    \\
                                         & BQMall                                    & 832$\times$2                 & -3.10\%                            & -0.86\%                    \\
                                         & PartyScene                                & 832$\times$2                 & -2.65\%                            & -0.69\%                    \\
                                         & RaceHorsesC                               & 832$\times$2                 & -6.13\%                            & -3.25\%                    \\
        \multirow{4}{*}{D}               & BasketballPass                            & 416$\times$2                 & -7.71\%                            & -2.69\%                    \\
                                         & BlowingBubbles                            & 416$\times$2                 & -3.15\%                            & -0.75\%                    \\
                                         & BQSquare                                  & 416$\times$2                 & -2.24\%                            & -0.56\%                    \\
                                         & RaceHorses                                & 416$\times$2                 & -7.23\%                            & -3.58\%                    \\
        \multirow{6}{*}{E}               & FourPeople                                & 1280$\times$2                & -7.92\%                            & -3.97\%                    \\
                                         & Johnny                                    & 1280$\times$2                & -6.13\%                            & -3.04\%                    \\
                                         & KristenAndSara                            & 1280$\times$2                & -6.40\%                            & -2.82\%                    \\
                                         & Vidyo1                                    & 1280$\times$2                & -8.56\%                            & -3.65\%                    \\
                                         & Vidyo3                                    & 1280$\times$2                & -7.64\%                            & -3.80\%                    \\
                                         & Vidyo4                                    & 1280$\times$2                & -7.36\%                            & -3.04\%                    \\
        \multirow{4}{*}{F}               & BasketballDrillText                       & 832$\times$2                 & -2.21\%                            & -1.17\%                    \\
                                         & ChinaSpeed                                & 1024$\times$2                & -7.86\%                            & -1.47\%                    \\
                                         & SlideEditing                              & 1280$\times$2                & -7.20\%                            & -0.80\%                    \\
                                         & SlideShow                                 & 1280$\times$2                & -17.36\%                           & -6.73\%                    \\ \midrule
