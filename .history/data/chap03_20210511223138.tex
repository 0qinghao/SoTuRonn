...
\begin{equation}
    P_{i,j}^'={█{min⁡{R_{i,j-1},R_{i-1,j}},&R_{i-1,j-1}>max⁡{R_{i,j-1},R_{i-1,j} };@max⁡{R_{i,j-1},R_{i-1,j}},&R_{i-1,j-1}<min⁡{R_{i,j-1},R_{i-1,j} };@R_{i,j-1}+R_{i-1,j}-R_{i-1,j-1},&Otherwise.}┤
\end{equation}
