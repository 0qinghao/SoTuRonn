...
\begin{tabular}{clccc}
\hline
序列类别                    & \multicolumn{1}{c}{序列} & 分辨率       & 码率      & 编码时间     \\ \hline
\multirow{2}{*}{ClassA} & PeopleOnStreet         & 2560×1600 & -1.78\% & 100.98\% \\
                        & Traffic                & 2560×1600 & -1.89\% & 100.03\% \\
\multirow{5}{*}{ClassB} & BasketballDrive        & 1920×1080 & -2.28\% & 101.06\% \\
                        & BQTerrace              & 1920×1080 & -1.80\% & 101.31\% \\
                        & Cactus                 & 1920×1080 & -1.15\% & 101.28\% \\
                        & Kimono                 & 1920×1080 & -1.57\% & 101.27\% \\
                        & ParkScene              & 832×480   & -1.48\% & 101.29\% \\
\multirow{4}{*}{ClassC} & BasketballDrill        & 832×480   & -1.96\% & 100.82\% \\
                        & BQMall                 & 832×480   & -1.46\% & 100.82\% \\
                        & PartyScene             & 832×480   & -1.42\% & 100.49\% \\
                        & RaceHorsesC            & 832×480   & -1.46\% & 100.50\% \\
\multirow{4}{*}{ClassD} & BasketballPass         & 416×240   & -2.62\% & 100.00\% \\
                        & BlowingBubbles         & 416×240   & -1.05\% & 100.00\% \\
                        & BQSquare               & 416×240   & -1.54\% & 100.63\% \\
                        & RaceHorses             & 416×240   & -1.17\% & 101.32\% \\
\multirow{3}{*}{ClassE} & FourPeople             & 1280×720  & -3.52\% & 100.73\% \\
                        & Johnny                 & 1280×720  & -4.11\% & 100.95\% \\
                        & KristenAndSara         & 1280×720  & -4.40\% & 100.80\% \\
\multirow{4}{*}{ClassF} & BasketballDrillText    & 832×480   & -1.96\% & 101.00\% \\
                        & ChinaSpeed             & 1024×768  & -4.75\% & 100.45\% \\
                        & SlideEditing           & 1280×720  & -2.64\% & 100.66\% \\
                        & SlideShow              & 1280×720  & -5.43\% & 102.68\% \\ \hline
\multicolumn{2}{l}{ClassA$\sim$E 均值}             & -         & -2.04\% & 100.79\% \\ \hline
\multicolumn{2}{l}{ClassF 均值}                    & -         & -3.70\% & 101.20\% \\ \hline
\multicolumn{2}{l}{ClassA$\sim$F 均值}             & -         & -2.34\% & 100.87\% \\ \hline
\multicolumn{2}{l}{解码时间}                         & \multicolumn{3}{c}{100.71\%}   \\ \hline
\end{tabular}
\end{table}
