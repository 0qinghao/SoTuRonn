...
\begin{tabular}{clcccc}
\multirow{2}{*}{序列类别} & \multicolumn{1}{c}{\multirow{2}{*}{序列}} & \multicolumn{4}{c}{通道}                    \\
                      & \multicolumn{1}{c}{}                    & Y        & Cb       & Cr       & All      \\
...
\multirow{5}{*}{B}    & BasketballDrive                         & -2.74\%  & -3.72\%  & -9.90\%  & -4.30\%  \\
                      ...
                      & Kimono                                  & -6.74\%  & -13.72\% & -21.14\% & -9.07\%(-7.57\%)  \\
                      & ParkScene                               & -7.50\%  & -9.36\%  & -10.43\% & -7.95\%  \\
...
\multirow{4}{*}{F}    & BasketballDrillText                     & -3.39\%  & -3.30\%  & -5.83\%  & -4.50\%  \\
                      & ChinaSpeed                              & -19.37\% & -15.40\% & -16.22\% & -18.56\% \\
                      & SlideEditing                            & -16.86\% & -8.24\%  & -9.54\%  & -15.49\% \\
                      & SlideShow                               & -25.25\% & -26.96\% & -26.22\% & -26.42\% \\
\multicolumn{2}{l}{ClassA$\sim$E 均值}                            & -7.90\%  & -11.19\% & -13.10\% & -8.87\%  \\
\multicolumn{2}{l}{ClassF 均值}                                   & -16.22\% & -13.48\% & -14.45\% & -16.24\% \\
\multicolumn{2}{l}{ClassA$\sim$F 均值}                            & -9.42\%  & -11.61\% & -13.35\% & -10.21\% \\
\multicolumn{2}{l}{编码时间}                                        & \multicolumn{4}{c}{129\%}                 \\
\multicolumn{2}{l}{解码时间}                                        & \multicolumn{4}{c}{103\%}                
\end{tabular}
\end{table}
