...
ClassA\textasciitilde E 中，序列 KristenAndSara 得到了最大的 4.40\% 的编码效率提升，均值为 8.10\%；ClassF 中，序列 SlideShow 获得了最大的 22.26\% 的编码效率提升，均值为 14.76\%。算法复杂度方面，L-IP 使编码时间增加了 25\%，解码时间基本不变，证明 L-IP 算法性能良好，具有较高的应用价值。
