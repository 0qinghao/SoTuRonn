...
\multirow{2}{*}{序列类别} & \multirow{2}{*}{序列} & \multirow{2}{*}{分辨率} & \multicolumn{2}{l}{H.265 + R-MED vs}            & \multicolumn{2}{l}{H.266 + R-MED vs}          \\
                      &                     &                      & H.265   bypass TransQuant & H.265 RDPCM {[}5{]} & H.266 bypass TransQuant & H.266 BDPCM {[}1{]} \\
A   & PeopleOnStreet       & 2560x1600 & -11.10\% & -5.99\% & -9.67\%  & -5.99\% \\
A   & Traffic              & 2560x1600 & -10.10\% & -3.54\% & -8.60\%  & -3.77\% \\
B   & BasketballDrive      & 1920x1080 & -2.19\%  & -0.49\% & -1.42\%  & -0.52\% \\
B   & BQTerrace            & 1920x1080 & -5.43\%  & -0.96\% & -4.16\%  & -1.15\% \\
B   & Cactus               & 1920x1080 & -2.92\%  & -0.99\% & -2.14\%  & -1.05\% \\
B   & Kimono               & 1920x1080 & -6.82\%  & -2.63\% & -5.96\%  & -3.35\% \\
C   & ParkScene            & 832x480   & -5.85\%  & -2.26\% & -4.87\%  & -2.58\% \\
C   & BasketballDrill      & 832x480   & -2.61\%  & -1.14\% & -1.92\%  & -1.22\% \\
C   & BQMall               & 832x480   & -4.16\%  & -0.66\% & -3.10\%  & -0.86\% \\
C   & PartyScene           & 832x480   & -3.80\%  & -0.51\% & -2.65\%  & -0.69\% \\
D   & RaceHorsesC          & 416x240   & -7.03\%  & -2.64\% & -6.13\%  & -3.25\% \\
D   & BasketballPass       & 416x240   & -9.10\%  & -1.92\% & -7.71\%  & -2.69\% \\
D   & BlowingBubbles       & 416x240   & -4.11\%  & -1.93\% & -3.15\%  & -0.75\% \\
D   & BQSquare             & 416x240   & -3.10\%  & -0.48\% & -2.24\%  & -0.56\% \\
D   & RaceHorses           & 416x240   & -8.29\%  & -3.53\% & -7.23\%  & -3.58\% \\
E   & FourPeople           & 1280x720  & -9.23\%  & -3.83\% & -7.92\%  & -3.97\% \\
E   & Johnny               & 1280x720  & -6.99\%  & -2.58\% & -6.13\%  & -3.04\% \\
E   & KristenAndSara       & 1280x720  & -7.35\%  & -2.60\% & -6.40\%  & -2.82\% \\
E   & Vidyo1               & 1280x720  & -9.93\%  & -3.30\% & -8.56\%  & -3.65\% \\
E   & Vidyo3               & 1280x720  & -9.10\%  & -3.60\% & -7.64\%  & -3.80\% \\
E   & Vidyo4               & 1280x720  & -8.92\%  & -2.65\% & -7.36\%  & -3.04\% \\
F   & BasketballDrillText  & 832x480   & -3.01\%  & -1.19\% & -2.21\%  & -1.17\% \\
F   & ChinaSpeed           & 1024x768  & -9.13\%  & -1.35\% & -7.86\%  & -1.47\% \\
F   & SlideEditing         & 1280x720  & -7.33\%  & -0.51\% & -7.20\%  & -0.80\% \\
F   & SlideShow            & 1280x720  & -18.45\% & -5.16\% & -17.36\% & -6.73\% \\
\multicolumn{2}{l}{平均码率优化} &           & -7.04\%  & -2.26\% & -5.98\%  & -2.50\% \\
\multicolumn{2}{l}{编码时间}   &           & 104\%    & 107\%   & 117\%    & 111\%   \\
\multicolumn{2}{l}{解码时间}   &           & 95\%     & 98\%    & 83\%     & 93\%   
\end{tabular}
\end{table}
