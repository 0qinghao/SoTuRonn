...
\multirow{2}{*}{序列类别} & \multirow{2}{*}{序列} & \multicolumn{2}{l}{H.265+R-MED vs} & \multicolumn{2}{l}{H.266+R-MED vs} \\
                   &                 & bypass TransQuant & RDPCM {[}5{]} & bypass TransQuant & BDPCM {[}1{]} \\
\multirow{2}{*}{A} & PeopleOnStreet  & -11.10\%          & -5.99\%       & -9.67\%           & -5.99\%       \\
                   & Traffic         & -10.10\%          & -3.54\%       & -8.60\%           & -3.77\%       \\
\multirow{4}{*}{B} & BasketballDrive & -2.19\%           & -0.49\%       & -1.42\%           & -0.52\%       \\
                   & BQTerrace       & -5.43\%           & -0.96\%       & -4.16\%           & -1.15\%       \\
                   & Cactus          & -2.92\%           & -0.99\%       & -2.14\%           & -1.05\%       \\
                   & Kimono          & -6.82\%           & -2.63\%       & -5.96\%           & -3.35\%       \\
\multirow{5}{*}{C} & ParkScene       & -5.85\%           & -2.26\%       & -4.87\%           & -2.58\%       \\
                   & BasketballDrill & -2.61\%           & -1.14\%       & -1.92\%           & -1.22\%       \\
                   & BQMall          & -4.16\%           & -0.66\%       & -3.10\%           & -0.86\%       \\
                   & PartyScene      & -3.80\%           & -0.51\%       & -2.65\%           & -0.69\%       \\
                   & RaceHorsesC     & -7.03\%           & -2.64\%       & -6.13\%           & -3.25\%       \\
\multirow{4}{*}{D} & BasketballPass  & -9.10\%           & -1.92\%       & -7.71\%           & -2.69\%       \\
                   & BlowingBubbles  & -4.11\%           & -1.93\%       & -3.15\%           & -0.75\%       \\
                   & BQSquare        & -3.10\%           & -0.48\%       & -2.24\%           & -0.56\%       \\
                   & RaceHorses      & -8.29\%           & -3.53\%       & -7.23\%           & -3.58\%       \\
\multirow{6}{*}{E} & FourPeople      & -9.23\%           & -3.83\%       & -7.92\%           & -3.97\%       \\
                   & Johnny          & -6.99\%           & -2.58\%       & -6.13\%           & -3.04\%       \\
                   & KristenAndSara  & -7.35\%           & -2.60\%       & -6.40\%           & -2.82\%       \\
                   & Vidyo1          & -9.93\%           & -3.30\%       & -8.56\%           & -3.65\%       \\
                   & Vidyo3          & -9.10\%           & -3.60\%       & -7.64\%           & -3.80\%       \\
                   & Vidyo4          & -8.92\%           & -2.65\%       & -7.36\%           & -3.04\%       \\
\multirow{4}{*}{F}    & BasketballDrillText & -3.01\%          & -1.19\%         & -2.21\%          & -1.17\%         \\
                   & ChinaSpeed      & -9.13\%           & -1.35\%       & -7.86\%           & -1.47\%       \\
                   & SlideEditing    & -7.33\%           & -0.51\%       & -7.20\%           & -0.80\%       \\
                   & SlideShow       & -18.45\%          & -5.16\%       & -17.36\%          & -6.73\%       \\
